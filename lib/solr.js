 ...
 * Loops the argument object and call function with the same name as the
 * argument passing the value as parameter.
 *
 * @param {Object} [opt]  - query json representing the Query. May be null.
 * @return {Query} Solr query object formed with the current arguments,
 * if no arguments are passed then a default Solr query object is returned
 * instead.
 * @api public
 */
